...
function CardActivitySection({ cardComments = [], handleAddCardComment }) {
  const currentUser = useSelector(selectCurrentUser);

  const onAddCardComment = (event) => {
    ...
    if (event.key === "Enter" && !event.shiftKey) {
      ...
      handleAddCardComment(commentToAdd).then(() => {
        event.target.value = "";
      });
    }
  };
